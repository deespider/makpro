        ...
        {/*====================== banner =======================*/}
                ...
                <div className='space'>
                    <div className='banner_cont'>
                        <div className='banner_cont_divc'>
                            ...
                            <p className='banner_cont_p4'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eleifend, velit eu cursus vulputate, justo nisi pretium orci, a mollis augue metus nec risus.</p>
            ...
            <div className='homediv1'>
                <div className='homediv11'>
                    <h1>Our <span>Tech Talks</span></h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Sed eleifend, velit eu cursus vulputate, justo nisi pretium orci,
            ...
            {/*================== campus partner ================*/}
            <div className='cp'>
                <div className="cpp"><h1>OUR CAMPUSING <span>PARTNER</span></h1></div>
